...
<<<<<<< HEAD
    	<strong>Copyright &copy; <?php echo date("Y") ?> <a target="_blank" href="<?php echo $root_html; ?>es2">ES2</a>.</strong> Todos os direitos reservados.
=======
    	<strong>Copyright &copy; <?php echo date("Y") ?> <a target="_blank" href="http://www.futurocientista.net">Programa Futuro Cientista</a>.</strong> Todos os direitos reservados.
...
<script type="text/javascript"
 src="<?php echo $root_html?>es2/web/plugins/datetimepicker/bootstrap-datetimepicker.min.js">
</script>
<script type="text/javascript"
 src="<?php echo $root_html?>es2/web/plugins/datetimepicker/bootstrap-datetimepicker.pt-BR.js">
</script>
